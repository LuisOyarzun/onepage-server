<?php
  ...
  {
    $codigoArepetir = $codigoArepetir.'<div class="u-effect-fade u-gallery-item"><div class="u-back-slide"><img class="u-back-image u-expanded" src="'.$arr["productosServicios"]["producto".$i]["ruta"].'" alt="Titulo" src="'.$arr["productosServicios"]["producto".$i]["hipervinculo"].'">
