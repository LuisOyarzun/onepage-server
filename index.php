            ...
            <div class="u-layout-row">
              <div class="u-container-style u-layout-cell u-left-cell u-size-30 u-layout-cell-1">
                <div class="u-container-layout u-valign-top u-container-layout-1">
                  <h4 class="u-text u-text-1">SUBTITULO 3<br>
                  </h4>
                  <h2 class="u-text u-text-2">Titulo 8</h2>
                  <p class="u-text u-text-grey-30 u-text-3">Este, es el párrafo 7 de la página web generada. Intente tener esta misma cantidad de palabras para un mejor estilo. La idea central de esta web es brindar un ejemplo visual de como se vería el one-page generado desde la plataforma central. Recuerda que puedes editar no solo los párrafos, títulos y subtítulos de la web, si no también sus colores para que combinen con los colores de tu servicio o institución.<br>
                  </p>
                </div>
              </div>
              <div class="u-container-style u-layout-cell u-right-cell u-size-30">
                <div class="u-container-layout u-container-layout-2">
                  ...
                  <p class="u-text u-text-grey-30 u-text-5">parrafo8</p>
                  <p class="u-text u-text-grey-30 u-text-6">Dirección</p>
                  <p class="u-text u-text-grey-30 u-text-7">parrafo9</p>
