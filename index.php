<?php
  ...
  while($i<=intval($cantidadProductos))
  {
    ...
    </div><div class="u-over-slide u-shading u-over-slide-1" src="'.$arr["productosServicios"]["producto".$i]["hipervinculo"].'"><h3 class="u-gallery-heading">'.$arr["productosServicios"]["producto".$i]["titulo"].'</h3><p class="u-gallery-text">'.$arr["productosServicios"]["producto".$i]["parrafo"].'</p></div></div>';
    $i = $i+1;
  }
