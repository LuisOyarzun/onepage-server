<?php
  ...
  while($i<=intval($cantidadProductos))
  {
    ...
    </div><div class="u-over-slide u-shading u-over-slide-1"><h3 class="u-gallery-heading">'.$arr["productosServicios"]["producto1"]["titulo"].'</h3><p class="u-gallery-text">Esta es la descrpción de tu producto y/o servicio. Recuerda que hay un máximo
    que puedes verificar en nuestra sección de preguntas frecuentes.</p></div></div>';
    $i = $i+1;
  }
